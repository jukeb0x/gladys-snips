...
const prop = PropertiesReader('./conf/intent.properties');
...
console.log("message input "+message.input);
	...
	message.input +="l'item "+values[i]+",";
		  ...
		  message.input = "Règle le volume du haut parleur à "+getSlotValue(message, "percentage");
	      }
		  ...
		  message.input = "Positionne la luminosité à "+getSlotValue(message, "percentage");
	      }
