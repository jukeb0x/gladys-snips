...
message.text="<speed level='50'/><pitch level='140%'/><volume level='80%'/>"+message.text+"</volume></pitch></speed>";

//console.log("snips message to publish "+JSON.stringify(message));
